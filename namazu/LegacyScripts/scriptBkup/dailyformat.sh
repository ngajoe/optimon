...
#only format and import the files that were touched since last run
	...
	curl -X POST -H 'Content-type: application/json' --data '{"text":"Daily import completed."}' https://hooks.slack.com/services/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
